    ...
    return (
       ...
       <div>
        ...
        <div className="space-y-5">
            ...
            <p className="text-gray-500 xl:text-lg ">{shortDescription}</p>
            <h3 className="text-2xl mt-10 font-bold">All Details</h3>
            <p className="xl:text-lg  text-gray-500">{longDescription}</p>
        </div>
       </div>
        {/* right */}
        <div className="relative  drop-shadow-xl shadow-xl flex-1 shadow-black  p-[5%] xl:text-base ">
