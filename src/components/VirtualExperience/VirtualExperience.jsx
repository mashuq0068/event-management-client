...
const VirtualExperience = () => {
    ...
    return (
     <div  className='flex
     flex-col justify-center mx-auto items-center mt-12 lg:w-auto lg:mx-0 w-[370px] lg:mt-36'>
        
    
        
        <div data-aos-duration="1000" data-aos="fade-up"  className='text-4xl font-bold text-center duration-3000' >
        ...
        <div className='hidden md:flex lg:flex-row flex-col relative bottom-8  justify-between items-center lg:px-[10%] gap-5'> 
            ...
            <div className='drop-shadow-xl shadow-xl shadow-black'  >
            <img  data-aos-duration="1000" data-aos="fade-up-left" className='md:h-[500px] md:w-auto w-[90%]' src="https://media.istockphoto.com/vectors/virtual-meeting-vector-id1220035426?k=6&m=1220035426&s=170667a&w=0&h=FP3kk5dJtWYLd0s6_3rZR66wWaOHXKtTK3Snp68C2NI=" alt="" />
            </div>
        </div>
        {/* another */}
        <div className='hidden lg:flex-row md:flex  flex-col relative bottom-36 justify-between items-center lg:px-[10%] gap-5'> 
            <div className='drop-shadow-xl shadow-xl shadow-black'  >
            <img  data-aos-duration="1000" data-aos="fade-up-right " className='md:h-[500px] md:w-auto w-[90%]' src="https://thumbs.dreamstime.com/z/virtual-meeting-collective-home-video-conference-man-chatting-online-people-discussion-friends-internet-e-learning-chat-195820132.jpg" alt="" />
            </div>
            <div className='drop-shadow-xl shadow-xl  shadow-black'   >
            <img  data-aos-duration="1000" data-aos="fade-up-left" className='md:h-[500px] md:w-auto w-[90%]' src="https://remote-tools-images.s3.amazonaws.com/Office+Meeting.png" alt="" />
            </div>
        </div>
        <div data-aos-duration="1000" data-aos="fade-up"  className='drop-shadow-xl -z-50 shadow-xl relative lg:bottom-52  shadow-black'   >
