...
const PreviousDeal = ({previousDeal , i}) => {
    ...
    const {image ,id , eventName , eventType , location} = previousDeal
    return (
        
           <li className="flex justify-center py-2 lg:py-3 drop-shadow-xl shadow-xl   lg:grid grid-cols-3 lg:grid-cols-5 justify-items-center items-baseline font-semibold 2xl:text-xl">
          ...
          <p className="text-center hidden lg:block  w-max mx-auto">{location}</p>
